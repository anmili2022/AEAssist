...
{
    public class WarriorGCD_HolySpirit : IAIHandler
    {
        uint spell;
        static public uint GetSpell()
        {
            ...
            if (Warrior_SpellHelper.CheckUseAOE(2) && SpellsDefine.HolyCircle.IsUnlock())
        ...
        public int Check(SpellEntity lastSpell)
        {
            ...
            if (Warrior_SpellHelper.GCDNeededforCombo() == 1)
                return -6;
