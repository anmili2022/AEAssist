...

{
    ...
    /// Page1.xaml 的交互逻辑
    /// </summary>
    public partial class WarriorOverlayWindow : UserControl
    {
        public Action DragMove;

        public WarriorOverlayWindow()
        {
            InitializeComponent();
        }

        private void WarriorOverlayWindow_OnMouseMove(object sender, MouseEventArgs e)
        {
