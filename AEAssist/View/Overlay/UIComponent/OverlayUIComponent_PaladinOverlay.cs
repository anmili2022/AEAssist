...
namespace AEAssist.View.Overlay.UIComponent
{
    ...
    public class OverlayUIComponent_PaladinOverlay : OverlayUIComponent
    {
        private OverlayControl _control;

        public OverlayUIComponent_PaladinOverlay() : base(true)
        {
        }
        ...
        public override OverlayControl Control
        {
            get
            {
                ...
                var overlayUc = new PaladinOverlayWindow();
