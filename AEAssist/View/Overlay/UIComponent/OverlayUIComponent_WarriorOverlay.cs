...
namespace AEAssist.View.Overlay.UIComponent
{
    ...
    internal class OverlayUIComponent_WarriorOverlay : OverlayUIComponent
    {
        private OverlayControl _control;

        public OverlayUIComponent_WarriorOverlay() : base(true)
        {
        }
        ...
        public override OverlayControl Control
        {
            get
            {
                ...
                var overlayUc = new WarriorOverlayWindow();
