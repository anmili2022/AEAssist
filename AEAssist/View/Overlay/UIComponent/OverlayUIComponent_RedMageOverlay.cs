...
namespace AEAssist.View.Overlay.UIComponent
{
    ...
    internal class OverlayUIComponent_RedMageOverlay : OverlayUIComponent
    {
        private OverlayControl _control;

        public OverlayUIComponent_RedMageOverlay() : base(true)
        {
        }
        ...
        public override OverlayControl Control
        {
            get
            {
                ...
                var overlayUc = new RedMageOverlayWindow();
